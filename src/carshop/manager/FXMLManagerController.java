...
public class FXMLManagerController implements Initializable {
    ...
    private void handleButtonActionProfile(ActionEvent event) throws IOException {
     Parent home_page_parent = FXMLLoader.load(getClass().getResource("FXMLManagerProfile.fxml"));
 ...
 Parent home_page_parent = FXMLLoader.load(getClass().getResource("FXMLMAnagerCars.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
...
private void handleButtonActionEmployees (ActionEvent event) throws IOException {
       Parent home_page_parent = FXMLLoader.load(getClass().getResource("FXMLEmployeesList.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
